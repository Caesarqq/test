    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('donor', 'Донор'), ('buyer', 'Покупатель'), ('charity', 'Благотворительная организация'), ('admin', 'Администратор')], default='buyer', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ogrn', models.CharField(blank=True, max_length=13, null=True, unique=True, verbose_name='ОГРН')),
